...
#dirVideo="demonstration - PoorVisibilityConditions.mp4"
...
def process_frame(image, TotalLineHits):
    ...
    gray1 = cv2.GaussianBlur( masked_image, (3, 3), 0)
    ...
    hough_lines = cv2.HoughLinesP(img_concat, rho=1, theta=np.pi/180, threshold=50, minLineLength=20, maxLineGap=300)
